...
class Suite:
    ...
    def interactions(self):
        ...
        p.locator('[data-layer="apps"]').click()
        expect(p.locator('.stack-scene')).to_have_attribute('data-active-layer', 'apps')
        expect(p.locator('[data-stack-caption]')).to_contain_text('Applications')
        p.locator('[data-layer="linux"]').click()
        self.mark('Interactive system-layer illustration')
